  ...
  return (
    <div className="flex min-h-[100dvh] w-full items-center justify-center bg-[#f4f1e8] px-6">
      <div className="max-w-md text-center">
        ...
        <div className="mt-8 text-xs font-bold uppercase tracking-[.16em] text-[#aa7a0d]">Mizan / 404</div>
        ...
        <Link href="/" className="btn-primary mt-7" data-testid="link-404-home"><ArrowLeft size={16} /> Back to Mizan</Link>
      </div>
    </div>
  );
}
